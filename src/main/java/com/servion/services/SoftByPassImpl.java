...
public class SoftByPassImpl implements ISoftByPass{
	...
	@Override
	public String getSoftByPassPhrases(CallInfo callInfo) throws ServiceException {
		...
		if(logger.isInfoEnabled()){WriteLog.write(WriteLog.INFO,session_ID_, "ENTER:SoftByPassImpl.getSoftByPassPhrases()");}

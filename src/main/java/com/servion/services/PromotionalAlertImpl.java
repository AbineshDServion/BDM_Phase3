...
public class PromotionalAlertImpl implements IPromotionalAlert{
	...
	@Override
	public String getPromotionalAlertMenuPhrases(CallInfo callInfo)
		...
		if(logger.isInfoEnabled()){WriteLog.write(WriteLog.INFO,session_ID_, "ENTER:PromotionalAlertImpl.getReportLostCardMenuPhrases()");}

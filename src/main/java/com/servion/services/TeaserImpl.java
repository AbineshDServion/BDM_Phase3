...
public class TeaserImpl implements ITeaser{
	...
	@Override
	public String getTeaserPhrases(CallInfo callInfo) throws ServiceException {
		...
		if(logger.isInfoEnabled()){WriteLog.write(WriteLog.INFO,session_ID_, "ENTER:TeaserImpl.getTeaserPhrases()");}

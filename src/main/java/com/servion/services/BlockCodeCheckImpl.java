...
public class BlockCodeCheckImpl implements IBlockCodeCheck{
	...
	@Override
	public String getBlockCodePhrases(CallInfo callInfo) throws ServiceException {
	...
	@Override
	public boolean isCardBlocked(CallInfo arg0) throws ServiceException {
